...
import com.ZippSlipAutomation.admin.operations.UnpublishZippGramActions;
...
public class UnpublishZippGramMainClass {
	...
	public void selectPublishedZippGram() throws Exception {
		UnpublishZippGramActions unpublishZippGramActions = new UnpublishZippGramActions();
		unpublishZippGramActions.selectPublishedZippGram();

	}

	@Test(dependsOnMethods = "selectPublishedZippGram")
	public void unpublishZippGram() throws Exception {
		UnpublishZippGramActions unpublishZippGramActions = new UnpublishZippGramActions();
		unpublishZippGramActions.unpublishZippGram();
