...
public class FormExportMainClass {
	...
	public void selectExportForm() throws Exception {
		UnpublishActivityActions unpublishActivityActions = new UnpublishActivityActions();
		unpublishActivityActions.selectExportForms();

	}
	
	@Test(dependsOnMethods = "selectExportForm")
	public void selectPrintForms() throws Exception {
		UnpublishActivityActions unpublishActivityActions = new UnpublishActivityActions();
		unpublishActivityActions.selectPrintForms();

	}
	
	
	@Test(dependsOnMethods = "selectPrintForms")
