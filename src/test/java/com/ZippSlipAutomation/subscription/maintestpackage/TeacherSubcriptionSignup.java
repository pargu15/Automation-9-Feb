...
public class TeacherSubcriptionSignup {
	...
	public void registerTeacher() throws Exception {
		...
		//buySubscriptionActions.getFlyerFunctionality();
		buySubscriptionActions.registerNewTeacherFunctionality();
		//buySubscriptionActions.enterOTPFunctionality();
		//buySubscriptionActions.FindMySchoolFunctionality();
		buySubscriptionActions.AddMySchoolFunctionality();
	...
	public void TeacherOnboading() throws Exception {
		BuySubscriptionActions buySubscriptionActions = new BuySubscriptionActions();
		buySubscriptionActions.TeacherOnboading();	
	}
	@Test(priority = 3)
	...
	@Test(priority = 7)
	public void Start30DaysTrialFunctionality() throws Exception {
	BuySubscriptionActions buySubscriptionActions = new BuySubscriptionActions();
	buySubscriptionActions.Start30DaysTrial();
	...
	@Test(priority = 8)
	public void UpgradetoPermissionFunctionality() throws Exception {
		BuySubscriptionActions buySubscriptionActions = new BuySubscriptionActions();
		buySubscriptionActions.UpgradetoPermission();
