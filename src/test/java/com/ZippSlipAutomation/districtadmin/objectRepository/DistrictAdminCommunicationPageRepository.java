...
public class DistrictAdminCommunicationPageRepository {
	...
	@FindBy(id = "MainContent_ParticipantControl_cblDistrictGroups_2")
	private WebElement oDistrictStudentsGroup;

	public ReturnElement getDistrictStudentsGroup() {
		return new ReturnElement(oDistrictStudentsGroup, Thread.currentThread().getStackTrace()[1].getMethodName());
