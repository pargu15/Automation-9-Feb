...
public class FormPacketPageRepository {
	...
	@FindBy(id = "MainContent_ucSelectActivityControl_btnCreateFormPacket")
	private WebElement oCreateFormPacket;

	public ReturnElement getCreateFormPacketButton() {
		return new ReturnElement(oCreateFormPacket, Thread.currentThread().getStackTrace()[1].getMethodName());
